    ...
    <footer className="bg-white text-zinc-600 border-t border-zinc-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Product */}
          <div>
            <h3 className="text-zinc-900 font-semibold mb-4">{t('product')}</h3>
            <ul className="space-y-2">
              <li>
                <LocalizedLink href="/plans" className="hover:text-zinc-900 transition-colors">
                  {t('plans')}
                </LocalizedLink>
              </li>
              <li>
          ...
          {/* Company */}
          <div>
            <h3 className="text-zinc-900 font-semibold mb-4">{t('company')}</h3>
            <ul className="space-y-2">
              <li>
                <a href="#" className="hover:text-zinc-900 transition-colors">
                  {t('about')}
